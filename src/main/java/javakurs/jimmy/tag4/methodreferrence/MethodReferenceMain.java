...
public final class MethodReferenceMain {
    ...
    private static void task1() {
        ...
        //final Function<String, Integer> stringToIntegerConverter = String -> MethodReferenceMain.customParseIntImplementation(String);
    ...
    private static void task2() {
        ...
        final Double d1 = i1.calculateSquareRoot();
        final Double d2 = i2.calculateSquareRoot();
    ...
    private static void task3() {
        ...
        final Integer i2 = doubleAdder.apply(i1a, i1b);

        MethodReferenceTest.checkTask3(i1, i2);
    }

    private static Integer add(Double a, Double b) {
    ...
    private interface TriFunction {
        Integer calculate(final BiFunction<Double, Double, Integer> biFunction, final Double a, final Double b, final int c);
    }
    ...
    private static void task5() {
        ...
        //Hier der Code für den Aufruf des integerPrinters:
