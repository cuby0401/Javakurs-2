...
public final class LambdaMain {
    ...
    private static void task1() {
        ...
        final BiFunction<Double, Double, Integer> doubleAdder = (a, b) -> (int) Math.round(a + b);
    ...
    private static void task2() {
        ...
        final TriFunction<Double, Double, Double, Integer> doubleAdder = (a, b, c) -> (int) (a + b + c);
    ...
    private static void task3() {
        ...
        final IntegerExtractor<Task3Record, Integer> intExtractor = null;

        final Integer i1 = null;
