...
AnonymousFilterMain {
    ...
    private static void task1(final List<Integer> integerList) {
        final List<Integer> unevenNumbersSmallerThan10 = ListFilterUtil.filterList(
                integerList, new AnonymousFilter() {
                    @Override
                    protected boolean filter1(int elementToCheck) {
    ...
    private static void task2(final List<Integer> integerList) {
        final List<Integer> dividableBy5ButNotBy10 = ListFilterUtil.filterList(
                integerList, new AnonymousFilter() {
                    @Override
                    protected boolean filter1(int elementToCheck) {
    ...
    private static void task4(final List<Integer> integerList) {
        final List<Integer> squareRootBiggerThan4XorDividableBy9 = ListFilterUtil.filterList(integerList, new AnonymousFilter() {
            @Override
            protected boolean filter1(int elementToCheck) {
                return false;
            }
            ...
            @Override
            protected FilterConjunctionEnum filterConjunction() {
                return FilterConjunctionEnum.XOR;
            }
        }); //null mit AnonymousFilter ersetzen
    ...
    private static void task5(final List<Integer> integerList) {
        final List<Integer> allDigitsSmallerThan3OrBiggerThan7 = ListFilterUtil.filterList(integerList, new AnonymousFilter() {
            @Override
            protected boolean filter1(int elementToCheck) {
                return false;
            }
